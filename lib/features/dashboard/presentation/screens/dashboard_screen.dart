                ...
                return GridView.count(
                  ...
                  children: [
                    _KPICard(
                      ...
                      value: patientsAsync.when(data: (d) => d.length.toString(), loading: () => '...', error: (_, __) => '0'),
                      icon: LucideIcons.users,
                      color: Colors.blue,
                    ),
                    _KPICard(
                      title: 'Appointments',
                      value: appointmentsAsync.when(data: (d) => d.length.toString(), loading: () => '...', error: (_, __) => '0'),
                      icon: LucideIcons.calendar,
                      color: Colors.purple,
                    ),
                    _KPICard(
                      title: 'Low Stock',
                      value: inventoryAsync.when(data: (d) => d.where((m) => m.stockQuantity < 10).length.toString(), loading: () => '...', error: (_, __) => '0'),
